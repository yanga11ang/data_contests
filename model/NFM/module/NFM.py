...
class NFM(torch.nn.Module):
    ...
    def fit(self, Xi_train, Xv_train, y_train, Xi_valid=None, Xv_valid=None,
        ...
        is_valid = False
        # print("Xi_train shape ",Xi_train.shape,"self.field_size:",self.field_size)
        ...
        for epoch in range(self.n_epochs):
            ...
            if is_valid:
                ...
                print('[%d] valid loss: %.6f metric: %.6f time: %.1f s' %
...
if __name__ =='__main__':
    ...
    nfm.fit(result_dict['index'], result_dict['value'], result_dict['label'],
            valid_dict['index'], valid_dict['value'], valid_dict['label'], ealry_stopping=True, refit=False,
            save_path='./nfm.pkl')
